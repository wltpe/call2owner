...
public partial class DataContext : DbContext
{
    ...
    public virtual DbSet<CabCompany> CabCompanies { get; set; }
    ...
    public virtual DbSet<OperatorMasterServiceType> OperatorMasterServiceTypes { get; set; }

    public virtual DbSet<Permission> Permissions { get; set; }

    public virtual DbSet<PlanCircleCode> PlanCircleCodes { get; set; }

    public virtual DbSet<PlanOperatorCode> PlanOperatorCodes { get; set; }

    public virtual DbSet<PlanProvider> PlanProviders { get; set; }

    public virtual DbSet<Provider> Providers { get; set; }

    public virtual DbSet<Queue> Queues { get; set; }

    public virtual DbSet<RechargeRequest> RechargeRequests { get; set; }

    public virtual DbSet<RechargeRequestDispute> RechargeRequestDisputes { get; set; }

    public virtual DbSet<Refund> Refunds { get; set; }

    public virtual DbSet<RequestMapper> RequestMappers { get; set; }
    ...
    public virtual DbSet<ResidentFrequentlyEntry> ResidentFrequentlyEntries { get; set; }

    public virtual DbSet<ResidentFrequentlyGuest> ResidentFrequentlyGuests { get; set; }

    public virtual DbSet<ResidentPet> ResidentPets { get; set; }

    public virtual DbSet<ResidentVehicle> ResidentVehicles { get; set; }

    public virtual DbSet<Resource> Resources { get; set; }

    public virtual DbSet<ResourceMapper> ResourceMappers { get; set; }
    ...
    public virtual DbSet<VisitingHelpCategory> VisitingHelpCategories { get; set; }

    public virtual DbSet<VisitingHelpCategoryCompany> VisitingHelpCategoryCompanies { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Refund>(entity =>
        {
            ...
            entity.HasIndex(e => e.UserName, "IX_Refund_UserName");

            entity.Property(e => e.Id).ValueGeneratedNever();
            entity.Property(e => e.Amount).HasColumnType("decimal(18, 2)");
            entity.Property(e => e.Utrsource).HasColumnName("UTRSource");

            entity.HasOne(d => d.UserNameNavigation).WithMany(p => p.Refunds).HasForeignKey(d => d.UserName);
        });
        ...
        modelBuilder.Entity<SocietyUser>(entity =>
        {
            ...
            entity.HasOne(d => d.User).WithMany(p => p.SocietyUsers).HasForeignKey(d => d.UserId);
        });
        ...
        modelBuilder.Entity<User>(entity =>
        {
            ...
            entity.HasOne(d => d.Roles).WithMany(p => p.Users).HasForeignKey(d => d.RolesId);
        });
        ...
        modelBuilder.Entity<UserFavorite>(entity =>
        {
            ...
            entity.HasOne(d => d.UserNameNavigation).WithMany(p => p.UserFavorites).HasForeignKey(d => d.UserName);
        });
